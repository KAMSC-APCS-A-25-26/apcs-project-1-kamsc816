/*
This game is called TGL Too Slow, and it follows the journey of a runner. The runner can increase in speed and stamina and gain/lose energy to help on the quest to win a state championship. To play, answer the questions with the input examples provided to make your decision. Good luck!
*/
...
public class TextAdventure {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < run; i++) {
            ...
            // Gender input
            do {
                System.out.print("Do you want it to be hard or normal? (h/n): ");
                gender = sc.nextLine().trim().toLowerCase();
            } while (!gender.equals("h") && !gender.equals("n"));
            ...
            if (racer > challenge) {
                if (kick == 1 && speed >= 7) {
                    ...
                    System.out.println("Stamina: " + stamina);
                    System.out.println("Speed: " + speed);
                    System.out.println("Overall: " + racer);
